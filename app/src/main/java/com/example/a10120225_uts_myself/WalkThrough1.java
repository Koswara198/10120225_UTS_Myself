...
public class WalkThrough1 extends AppCompatActivity {
    ...
    private com.example.a10120225_uts_myself.OnBoardingAdapter onBoardingAdapter;
        ...
        OnBoardingAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(onBoardingViewPager.getCurrentItem() + 1 < onBoardingAdapter.getItemCount()){
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.a10120225_uts_myself.HomeActivity.class));
                    finish();
                }
            }
        });
    ...
    private void setupOnBoardingItems(){
        List<com.example.a10120225_uts_myself.OnBoardingItem> onBoardingItems = new ArrayList<>();
        com.example.a10120225_uts_myself.OnBoardingItem item1 = new com.example.a10120225_uts_myself.OnBoardingItem();
        item1.setTittle("Halo");
        item1.setDescription("Selamat datang di My Self Apps");
        item1.setImage(R.drawable.sd);

        com.example.a10120225_uts_myself.OnBoardingItem item2 = new com.example.a10120225_uts_myself.OnBoardingItem();
        item2.setTittle("Identitas, Makanan dan Minuman Favorit, Aktivitas Sehari-hari,Video dan Musik, serta Kontak Saya");
        item2.setDescription("Bisa Kamu dapatkan di Aplikasi Ini");
        item2.setImage(R.drawable.who);

        com.example.a10120225_uts_myself.OnBoardingItem item3 = new com.example.a10120225_uts_myself.OnBoardingItem();
        item3.setTittle("Ready?");
        item3.setDescription("Lessgoooo!");
        ...
        onBoardingAdapter = new com.example.a10120225_uts_myself.OnBoardingAdapter(onBoardingItems);
    }
