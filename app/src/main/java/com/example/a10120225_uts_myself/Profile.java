...
//        });
        instagram.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.instagram.com/1atk_d/");
            }
        });
        ...
        location.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                gotoUrl("https://goo.gl/maps/2UCUYwqFVxizbRva8");
            }
        });
        //ass
    ...
    public void ClickDaily(View view) {
        //redirect to gallery
        HomeActivity.redirectActivity(this, com.example.a10120225_uts_myself.Daily.class);
    }
    ...
    public static void About(final Activity activity) {
        ...
        //set message
        builder.setMessage("BDR v1.0 This App Contains Personal Data About Adi Tata Koswara");
    ...
    public void onButtonTap(View v) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"aditatakoswara85@gmail.com"});
    ...
    public void callClick(View view) {
        ...
        intentCall.setData(Uri.parse("tel:0895613405069"));
